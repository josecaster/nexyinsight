package sr.we.views.components;

import com.vaadin.flow.component.icon.SvgIcon;

import java.util.Locale;

public enum MyLineAwesome {
    ...
    private MyLineAwesome() {
        this.svgName = this.name().toLowerCase(Locale.ENGLISH).replace("_", "-");
    }

    private MyLineAwesome(String svgName) {
    ...
    public SvgIcon create() {
        return new SvgIcon("/line-awesome/svg/" + this.getSvgName() + ".svg");
    }
}
