...
//                    variant.setSku(batchItems.getSku());
                        ...
                        if(add != null) {
                            if(add.getVariants() != null && !add.getVariants().isEmpty()) {
                                ...
                                if (batchItems.getRealQuantity() != null) {
                                    InventoryLevels inventoryLevels = getInventoryLevels(batchItems, add, section);
    ...
    private InventoryLevels getInventoryLevels(BatchItems batchItems, Item add, Section section) {
        Variant variant1 = add.getVariants().get(0);
